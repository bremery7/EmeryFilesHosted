...
(function () {
    ...
    */
    function injectImmediate() {
        ...
        // Start hidden — will fade in after repositioning
        footer.style.opacity = '0';
        footer.style.transition = 'opacity 0.3s ease';

        // Phase 1: append to end of body immediately
        document.body.appendChild(footer);
        ...
        var observer = new MutationObserver(function () {
            ...
            if (kmsFooter) {
                ...
                // Fade in now that it's in the correct position
                requestAnimationFrame(function () {
                    existingFooter.style.opacity = '1';
                });
            }
        });
