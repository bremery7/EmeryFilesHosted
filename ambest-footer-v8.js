...
(function () {
    ...
    */
    function init() {
        // If #outerWrap-ui-kit already exists, inject immediately
        var target = document.getElementById('outerWrap-ui-kit');
        if (target) {
            injectFooter(target);
            return;
        }
        ...
        var observer = new MutationObserver(function () {
            var t = document.getElementById('outerWrap-ui-kit');
            if (t) {
                observer.disconnect();
                injectFooter(t);
            }
