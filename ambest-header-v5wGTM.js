...
(function () {
    ...
    */
    ...
    /*
        ...
        Phase 1 — Immediate: inject GTM noscript first, then the AM Best
        header at the top of <body> the moment this script runs. The user
    ...
    */
    ...
    function injectImmediate() {
        // Step 1: GTM noscript MUST be first — inject before anything else
        injectGTMNoscript();

        // Step 2: Inject AM Best header (don't inject twice)
        if (document.querySelector('.amb-header')) return;
