...
(function () {
    ...
    function wireInteractivity(header) {
        ...
        header.querySelectorAll('.amb-header__menu > li > a').forEach(function (link) {
            link.addEventListener('click', function (e) {
                ...
                if (dropdown) {
                    ...
                    // Close all first, then open this one if it wasn't already open
                    closeAllDropdowns();
                    if (!isAlreadyOpen) {
        ...
        /* Second-level submenus — click to open/close on ALL screen sizes */
        ...
        /* Third-level submenus — click to open/close */
